        ...
        <div className="costum-container">
          ...
          <span className="cancle-btn" onClick={()=>cancleBtn()}><FaTimes /> </span>
              <div className="row align-items-center">
                ...
                <div className="col-md-4">
                  <figure>
                    <img src="/images/fbdm.jpg" alt="coverage4" />
                  </figure>
                </div>
              </div>
            </div>
          ...
          <span className="cancle-btn" onClick={()=>cancleBtn()}><FaTimes /> </span>
              <div className="row align-items-center">
                ...
                <div className="col-md-4">
                  <figure>
                    <img src="/images/itdm.jpg" alt="coverage1" />
                  </figure>
                </div>
              </div>
            </div>
          ...
          <span className="cancle-btn" onClick={()=>cancleBtn()}><FaTimes /> </span>
              <div className="row align-items-center">
                ...
                <div className="col-md-4">
                  <figure>
                    <img src="/images/profiling.jpg" alt="coverage2" />
                  </figure>
                </div>
              </div>
            </div>
          ...
          <div className={tab4 ? "toggle-content-wrapper invisible-contents bg-white open":"toggle-content-wrapper invisible-contents bg-white "} >
              ...
              <div className="row align-items-center">
                ...
                <div className="col-md-4">
                  <figure>
                    <img src="/images/gbdm.jpg" alt="coverage3" />
                  </figure>
                </div>
              </div>
            </div>
