...
const About = () => {
  const bannerData = {
    ...
    para: "Discover the Future of Research. Continuum Insights pioneers innovative online surveys and data-driven solutions Discover the Future of Research. Continuum Insights pioneers innovative online surveys and data-driven solutions.",
  };
  return (
    <div className="page-content">
      ...
      <div className="our-team py-5" id="team">
        <div className="container">
          <div className="row">
            <div className="col">
          ...
          <div className="row">
            <div className="col-md-4 col-sm-6 my-3">
              <div className="wrapper p-relative">
                <figure className="p-relative">
                  <img src="/images/about-us/team-member-1.jpg" alt="team1" />
                  <div className="member-name text-white">
                    ...
                    <div className="member-more">
                      ...
                      <p className="text-white mt-3">
                        Meet the visionary mind behind Continuum Insights –
                        Vikas Yadav. With a passion for innovation and a
                        background in market research, Vikas Yadav founded
                        Continuum Insights to redefine how we approach insights
                        in market research.
                      </p>
                    </div>
                  </div>
            ...
            <div className="col-md-4 col-sm-6 my-3">
              <div className="wrapper p-relative">
                <figure className="p-relative">
                  <img src="/images/about-us/team-member-2.jpg" alt="team2" />
                  <div className="member-name text-white">
                    <span className="Bold p-relative pb-2">
                      Director of Sales
                    </span>
                    ...
                    <div className="member-more">
                      ...
                      <p className="text-white mt-3">
                        Monika is not just a Director of Sales. She is a dynamic
                        leader with a fervent commitment to driving sales
                        strategies that propel organizations towards
            ...
            <div className="col-md-4 col-sm-6 my-3">
              <div className="wrapper p-relative">
                <figure className="p-relative">
                  <img src="/images/about-us/team-member-3.jpg" alt="team" />
                  <div className="member-name text-white">
                    ...
                    <div className="member-more">
                      ...
                      <p className="text-white mt-3">
                        Vijay Singh, a seasoned professional, serves as the
                        Supply Manager at Continuum Insights, demonstrating
                        unparalleled expertise in strategic sourcing, vendor
                        management etc.
                      </p>
                    </div>
                  </div>
                ...
                <figure className="p-relative">
                  ...
                  <div className="member-name text-white">
                    ...
                    <div className="member-more">
                      ...
                      <p className="text-white mt-3">
                        At Continuum Insights, we take pride in the strength of
                        our team — a diverse group of talented individuals
                        united by a shared passion for Market Research. Get to
        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-6 col-lg-6 col-md-12 order-r-2">
              <div className="service-left wow fadeInLeft animated">
                <div className="section-headding color-headding">
                  <label className="section-topik">Our Offerings</label>
                  <h2 className="section-title">
                    Customized research solutions driven by expertise and
                    innovative approaches, meeting the distinct needs of diverse
            ...
            <div className="col-xl-6 col-lg-6 col-md-12 order-r-1 flex-align justify-right">
              <div className="about-map-right wow fadeInRight animated">
...
export function generateMetadata({}) {
  return {
    title: "About Us - Continuum Insights",
    description:
      "Continuum Insights is more than just a research company. We are a team of passionate professionals who love to explore the world of data and share our insights with others. We have been in the industry for over 10 years, serving clients from various sectors and regions.",
      alternates: {
        canonical: '/about-us',
        languages: {
          'en-US': '/en-US',
    ...
    openGraph: {
      type: "website",
      url: "https://www.continuuminsights.com/about-us",
      title: "About Us - Continuum Insights",
      description:
        "Continuum Insights is more than just a research company. We are a team of passionate professionals who love to explore the world of data and share our insights with others. We have been in the industry for over 10 years, serving clients from various sectors and regions.",
    },
